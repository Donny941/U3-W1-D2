    ...
    return (
      <div className="container">
        <div className="text-center my-4">
          <Button variant="info" className="mx-2" onClick={() => this.setState({ books: Fantasy })}>
            Fantasy
          </Button>
          <Button variant="secondary" className="mx-2" onClick={() => this.setState({ books: History })}>
            History
          </Button>
          <Button variant="warning" className="mx-2" onClick={() => this.setState({ books: Horror })}>
            Horror
          </Button>
          <Button variant="danger" className="mx-2" onClick={() => this.setState({ books: Romance })}>
            Romance
          </Button>
